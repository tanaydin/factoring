...
#define GWERROR_INVALID_PARAMETER 1011	/* Invalid parameter passed to function */
#define GWERROR_NOT_IMPLEMENTED 1012	/* Function not implemented for current configuration */
#define GWERROR_RESOURCE_UNAVAILABLE 1013 /* Required resource not available */
#define GWERROR_TIMEOUT 1014		/* Operation timed out */
#define GWERROR_CORRUPTED_DATA 1015	/* Data corruption detected */
...
struct gwhandle_struct {
	...
	int	bench_pick_nth_fft;	/* Internal variable to force the FFT selection code to */
	...
	int	qa_pick_nth_fft;	/* Internal variable to force the FFT selection code to */
	...
	int	qa_picked_nth_fft;	/* Internal variable returning which FFT implementation was selected */
