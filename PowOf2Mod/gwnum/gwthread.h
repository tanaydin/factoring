...
/* Note: We use C++11 std::atomic in gwthread.cpp and export the routines through a C interface */
/* This approach provides better performance and compatibility across different compilers */
/* compared to using C11 _Atomic which has varying levels of support */
